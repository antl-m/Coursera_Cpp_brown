...
public:
    friend bool Unit::CollideWith(const Building &that) const;
    ...
    virtual bool CollideWith(const Building &that) const override {
        return geo2d::Collide(rec, that.rec);
    }
...
bool Unit::CollideWith(const Building &that) const {
    return geo2d::Collide(pos, that.rec);
}

class Tower : public GameObject {
public:
    friend bool Unit::CollideWith(const Tower &that) const;

    friend bool Building::CollideWith(const Tower &that) const;
    ...
    virtual bool CollideWith(const Tower &that) const override {
        return geo2d::Collide(circle, that.circle);
    }
...
bool Building::CollideWith(const Tower &that) const {
    return geo2d::Collide(rec, that.circle);
}

bool Unit::CollideWith(const Tower &that) const {
    return geo2d::Collide(pos, that.circle);
}

class Fence : public GameObject {
public:
    friend bool Unit::CollideWith(const Fence &that) const;

    friend bool Building::CollideWith(const Fence &that) const;

    friend bool Tower::CollideWith(const Fence &that) const;
    ...
    virtual bool CollideWith(const Fence &that) const override {
        return geo2d::Collide(seg, that.seg);
    }
...
bool Tower::CollideWith(const Fence &that) const {
    return geo2d::Collide(circle, that.seg);
}

bool Building::CollideWith(const Fence &that) const {
    return geo2d::Collide(rec, that.seg);
}

bool Unit::CollideWith(const Fence &that) const {
    return geo2d::Collide(pos, that.seg);
}
